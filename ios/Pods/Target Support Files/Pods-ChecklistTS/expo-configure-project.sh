...
with_node \
  ...
  --target "/Users/thomasdilling-hansen/Desktop/ReactNativeProjects/ChecklistTS.nosync/ios/Pods/Target Support Files/Pods-ChecklistTS/ExpoModulesProvider.swift" \
  --platform "apple" \
